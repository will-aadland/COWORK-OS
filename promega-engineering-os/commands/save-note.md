...
- **Suggest team sharing for high-value knowledge.** A non-obvious PLC fix, equipment-behavior insight, or cross-project decision: mention `/share-chat` or `promote-to-team` once.
